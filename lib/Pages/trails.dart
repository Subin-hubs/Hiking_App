                ...
                Wrap(
                  ...
                  children: _difficulties.map((d) {
                    ...
                    return ChoiceChip(
                      label: Text(d),
                      selected: selected,
                      onSelected: (_) => setSheetState(() => _selectedDifficulty = selected ? null : d),
                ...
                Wrap(
                  ...
                  children: _regions.map((r) {
                    ...
                    return ChoiceChip(
                      label: Text(r),
                      selected: selected,
                      onSelected: (_) => setSheetState(() => _selectedRegion = selected ? null : r),
                      selectedColor: Colors.green[700],
                      labelStyle: TextStyle(color: selected ? Colors.white : Colors.black),
                    );
                  }).toList(),
                ...
                Wrap(
                  ...
                  children: [7, 14, 21, 30].map((d) {
                    ...
                    return ChoiceChip(
                      label: Text('$d days'),
                      selected: selected,
                      onSelected: (_) => setSheetState(() => _maxDuration = selected ? null : d),
                      selectedColor: Colors.green[700],
                      labelStyle: TextStyle(color: selected ? Colors.white : Colors.black),
                    );
                  }).toList(),
                ...
                Wrap(
                  ...
                  children: [3000, 4000, 5000, 6000].map((e) {
                    ...
                    return ChoiceChip(
                      label: Text('${e}m'),
                      selected: selected,
                      onSelected: (_) => setSheetState(() => _maxElevation = selected ? null : e),
                      selectedColor: Colors.green[700],
                      labelStyle: TextStyle(color: selected ? Colors.white : Colors.black),
                    );
                  }).toList(),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.green[700],
        foregroundColor: Colors.white,
        title: const Text('Trails', style: TextStyle(fontWeight: FontWeight.bold)),
        actions: [
          if (_hasActiveFilters)
            IconButton(icon: const Icon(Icons.filter_alt_off), onPressed: _clearFilters),
          IconButton(icon: const Icon(Icons.tune), onPressed: _showFilterSheet),
          IconButton(icon: const Icon(Icons.refresh), onPressed: () => _loadTrails(forceRefresh: true)),
        ],
      ),
      body: Column(
        children: [
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search trails, regions...',
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    'Filters active · ${_filteredTrails.length} results',
                    style: TextStyle(color: Colors.green[700], fontSize: 12, fontWeight: FontWeight.w600),
                  ),
                  const Spacer(),
                  GestureDetector(
                    onTap: _clearFilters,
                    child: Text('Clear', style: TextStyle(color: Colors.red[400], fontSize: 12)),
                  ),
                ],
              ),
            ),
            ...
            child: _isLoading
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text('No trails match your search', style: TextStyle(color: Colors.grey[600])),
                  const SizedBox(height: 12),
                  TextButton(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(trail.region, style: TextStyle(color: Colors.grey[500], fontSize: screenWidth * 0.03)),
                      ],
                    ),
                    const SizedBox(height: 8),
                    Row(
                    ...
                    Text(
                      trail.bestSeason,
                      style: TextStyle(color: Colors.green[700], fontSize: screenWidth * 0.028, fontWeight: FontWeight.w500),
                    ),
                  ],
                ),
              ),
  ...
  Widget _miniStat(IconData icon, String value, double screenWidth) {
    return Row(
      children: [
        ...
        const SizedBox(width: 2),
        Text(value, style: TextStyle(color: Colors.grey[600], fontSize: screenWidth * 0.028, fontWeight: FontWeight.w500)),
      ],
    );
  }
}